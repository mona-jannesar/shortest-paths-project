...
from shortest_paths import bfs_shortest_paths, dijkstra_shortest_paths
...
def test_bfs_performance():
    ...
    dist, parent = bfs_shortest_paths(graph, start)
...
def test_dijkstra_performance():
    ...
    start = 0
    t0 = time.perf_counter()
    dist, parent = dijkstra_shortest_paths(graph, start)
    t1 = time.perf_counter()
    elapsed = t1 - t0
    # Loose bound; adjust as needed
